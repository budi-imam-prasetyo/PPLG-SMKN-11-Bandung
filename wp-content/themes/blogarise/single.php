...
<div class="container"> 
      ...
      <div class="row">
		...
		<?php if($blogarise_single_page_layout == "single-align-content-right"){ ?>
			<div class="col-lg-9">
		<?php } elseif($blogarise_single_page_layout == "single-align-content-left") { ?>
        	<div class="col-lg-9">
		<?php } elseif($blogarise_single_page_layout == "single-full-width-content") { ?>
			<div class="col-lg-12">
    	<?php } ?>
          <?php if(have_posts())
            {
          while(have_posts()) { the_post(); ?>
            <div class="bs-blog-post single"> 
              <div class="bs-header">
                ...
                <?php } ?>
                 <h1 class="title"> <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute( array('before' => esc_html_e('Permalink to: ','blogarise'),'after'  => '') ); ?>">
                  <?php the_title(); ?></a>
                </h1>
                ...
                <div class="bs-info-author-block">
                  ...
                  <span class="bs-author"><a class="auth" href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"> <img src="<?php echo get_avatar_url(150); ?>" alt="<?php the_author(); ?>"></a> <?php esc_html_e('By','blogarise'); ?>
