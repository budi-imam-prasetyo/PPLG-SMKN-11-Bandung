<?php
if (!function_exists('blogarise_banner_advertisement')):
    /**
     *
    ...
    function blogarise_banner_advertisement()
    {
        ...
        if (('' != blogarise_get_option('banner_advertisement_section')) ) { ?>
                ...
                <?php if (('' != blogarise_get_option('banner_advertisement_section'))):

                    $blogarise_banner_advertisement = blogarise_get_option('banner_advertisement_section');
                    ...
                    $blogarise_open_on_new_tab = blogarise_get_option('banner_advertisement_open_on_new_tab');
                    $blogarise_open_on_new_tab = ('' != $blogarise_open_on_new_tab) ? '_blank' : '';
                    $blogarise_center_logo_title = get_theme_mod('blogarise_center_logo_title',false);
